package com.flink.hotitems_analysis;

import com.flink.hotitems.beans.ItemViewCount;
import com.flink.hotitems.beans.UserBehavior;
...
public class HotItems {
    public static void main(String[] args) throws Exception {
        ...
        //2.读取数据创建DataStream
        //DataStreamSource<String> inputStream = env.readTextFile("G:\\Ideaworkspace\\UserBehaviorAnalysis\\HotltemsAnalysis\\src\\main\\resources\\UserBehavior.csv");
        ...
        //5. 收集同一商品的所有商品count数据， 排序输出top n

...
public class PageView {
    ...
    public static class TotlePvCount extends KeyedProcessFunction<Long, PageViewCount, PageViewCount>{
        ...
        public void processElement(PageViewCount value, Context ctx, Collector<PageViewCount> out) throws Exception {
            ...
            ctx.timerService().registerEventTimeTimer(value.getWindowEnd() + 1);//1毫秒，只要触发就可以了
        }

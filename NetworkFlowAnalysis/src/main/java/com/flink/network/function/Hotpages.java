...
import com.flink.network.beans.ApacheLogEvent;
...
public class Hotpages {
    public static void main(String[] args) throws Exception {
        ...
        //读取文件，转换成POJO
        //DataStream<String> inputStream = env.readTextFile("G:\\Ideaworkspace\\UserBehaviorAnalysis\\NetworkFlowAnalysis\\src\\main\\resources\\apache.log");
...
//        DataStream<String> inputStream = env.readTextFile(resource.getPath());
        ...
        DataStream<ApacheLogEvent> dataStream = inputStream
            ...
            Long timestamp = simpleDateFormat.parse(s[3]).getTime();
        ...
        SingleOutputStreamOperator<PageViewCount> windowAggStream = dataStream
                ...
                .keyBy(ApacheLogEvent::getUrl)  //这是方法引用，也可以用lamda表达式，data -> data.getUrl
